...
-- Drop existing voice room tables to fix schema issues
...
-- Create voice_rooms table with correct schema
...
-- Create voice_room_participants table with correct schema
